...
function __wbg_adapter_21(arg0, arg1, arg2) {
    try {
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb0644899213d0d25(arg0, arg1, addBorrowedObject(arg2));
    } finally {
...
*/
export function yewGetEventLog(comp_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.yewGetEventLog(retptr, comp_id);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('todomvc-8f6e6892533c88f2_bg.wasm', import.meta.url);
    }
    const imports = getImports();
